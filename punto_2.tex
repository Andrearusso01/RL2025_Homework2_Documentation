...
\item We created a ROS 2 service to update the aruco marker position in Gazebo. We started from the \lstinline|/set_pose| ign service and then created a \lstinline|parameter_bridge| in the previously created launch file. 
...
\newpage Then we tested the bridged service via ROS 2 service call:
